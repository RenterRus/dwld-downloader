...
[-] Вписать в Makefile команды для автоматического подтягивания и запуска/разворота/миграций(опционально) необходимых компонентов на сервере (memcached, sensors, sqlite3) <br>
